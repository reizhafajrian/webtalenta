...
const DocsCallout = (props) => {
  ...
  return (
    <CCallout color="info" className="bg-white">
      A React {name} component {plural ? "have" : "has"} been created as a
      native React.js version of Bootstrap {name}. {name}{" "}
      {plural ? "are" : "is"} delivered with some new features, variants, and
