...
const CreateArticle = React.lazy(() => import("./views/createarticle/CreateArticle.tsx"));
...
const routes = [
  // { path: "/admin/app", exact: true, name: "Home" },
  { path: "/admin/app/create-article", name: "Home", component: CreateArticle },
  { path: "/admin/app/color", name: "Color", component: Colors },
